...
type ConfigureDataSourceConfiguration struct {
	...
	AdpConfigureDataSourceMetaDataMappingToSimpleConfigParams []SimpleConfigParamArg `json:"adp_configureDataSource_metaDataMappingToSimpleConfigParams,omitempty"`
}
...
func WithConfigureDataSourceMetaDataMappingToSimpleConfigParams(configs []SimpleConfigParamArg) func(*ConfigureDataSourceConfiguration) {
	return func(c *ConfigureDataSourceConfiguration) {
		c.AdpConfigureDataSourceMetaDataMappingToSimpleConfigParams = configs
	}
}
